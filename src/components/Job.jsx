...
const Job = ({ job }) => {
    ...
    return (
        <div className='p-4 md:p-5 rounded-md shadow-md bg-white border border-gray-200'>
            ...
            <div className='flex items-center gap-2 my-2'>
                <Button className="p-2 md:p-3" variant="outline" size="icon">
                    <Avatar>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-4 mt-4'>
                ...
                <Button className="bg-[#7209b7] w-full sm:w-auto mt-2 sm:mt-0">
                    Save For Later
                </Button>
            </div>
        </div>
