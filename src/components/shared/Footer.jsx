      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex justify-center space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/SunkaraboinaPr3" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/sunkaraboina-praveen-84594a256/" className="hover:text-gray-400" aria-label="LinkedIn">
